...
Its name is `write_word_count` that takes a string `file_name` as argument, it opens the file in read mode.
It writes a comma separated file ("out_" + original filename), with the lowercase word as first value and count second. [Download test file](data/alien.txt)
