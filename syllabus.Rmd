...
The final exam date and time is to be determined (TBD).

<!-- -   `r schedule %>% filter(exam == "Final Exam" & term == "spring 2025") %>% pull(formatted_date)` -- `r schedule %>% filter(exam == "Final Exam" & term == "spring 2025") %>% pull(time)`.  --> 


You must keep this time available. Do not schedule any flights, travel plans, or other conflicts with these exams.

Common final exam room is TBD.
