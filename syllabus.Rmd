...
Every semester, students enroll in introductory CS classes but do not submit any work, resulting in a grade of `E` at the end of the term. To prevent this, at the end of the **second week** (September 1), all students who have not submitted/completed **five or more** of the following will be administratively dropped:

1.  Class presence on August 21
2.  August 23 quiz
3.  Class presence on August 25
4.  [Beginning of semester survey](https://uarizona.co1.qualtrics.com/jfe/form/SV_e3QarvVnEiImQ4K)
5.  Class presence on August 28
6.  August 30 quiz
7.  [Module 1 Programming Problem 1](https://adrianapicoral.com/csc-110/assignments-01.html)
8.  [Module 1 Programming Problem 2](https://adrianapicoral.com/csc-110/assignments-01.html)
9.  Class presence on September 1
...
-   Course D2L: <https://d2l.arizona.edu/d2l/home/1325409>
...
There will be four exams throughout the course (including the final), for a total of 55%. These exams may cover material from class, the programming assignments, the final project, and the readings. Three exams of these exams will be during the semester, the lowest grade will be dropped (each of the two remaining exam grades is worth 20% of your final grade). If you would like an exam regraded, we reserve the right to regrade the entire exam, not only the parts you might question.
...
```{r}
assignments %>% 
  select(assessment, formatted_date) %>% 
  kable(col.names = c("Assessment", "Date"))
```
