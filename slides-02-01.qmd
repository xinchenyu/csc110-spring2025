...
Print the exact characters shown in your quiz (there are different versions of the quiz)

Changes to the characters (for example, not printing the quotes or apostrophe) will be considered as an incorrect solution (zero grade awarded).
