...
-   `r schedule %>% filter(exam == "Final Exam" & term == "fall 2024") %>% pull(formatted_date)` -- `r schedule %>% filter(exam == "Final Exam" & term == "fall 2024") %>% pull(time)` 

The final exam room is TBD.
...
-   [Short Project 1]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 1") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 2]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 2") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 3]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 3") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 4]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 4") %>% pull(formatted_date)` at 9pm
...
-   Optional lab if you have missed one
...
-   [Short Project 5]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 5") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 6]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 6") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 7]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 7") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 8]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 8") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 9]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 9") %>% pull(formatted_date)` at 9pm
-   [Programming Project 9](project-8.html) -- Due date: `r assignments %>% filter(assessment == "Programming Project 9") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 10]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 10") %>% pull(formatted_date)` at 9pm
...
-   [Short Project 11]() -- Due date: `r assignments %>% filter(assessment == "Short Programming Project 11") %>% pull(formatted_date)` at 9pm
