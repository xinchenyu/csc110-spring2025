...
-   `r schedule %>% filter(exam == "Final Exam" & term == "spring 2024") %>% pull(formatted_date)` -- `r schedule %>% filter(exam == "Final Exam" & term == "spring 2024") %>% pull(time)` in [ENR2 N120](https://maps.app.goo.gl/Rx3se1ArtPWDPnEN7).
