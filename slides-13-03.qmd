...
#| echo: true
#| eval: false
assert is_prime(6) == False # divisible by 2 and 3
assert is_prime(5) == True # not divisible by 2 and 3
assert is_prime(11) == True # not divisible by any number between 2 and 6
```
