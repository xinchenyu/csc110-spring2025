...
It returns the highest value in the numbers.
...
assert max_list([2, 2, 1]) == 2
assert max_list([1, -3]) == 1 
```
...
-   Use option 1 if you want to mutate the list.
...
-   Use either options if you only need to get the values.
