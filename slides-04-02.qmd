...
* Midterm 1 this Wednesday (September 20) -- in this room, during class (unless you have DRC accommodations)
* BRING PHOTO ID
* Review session:
  * Tuesday, September 19, 5pm to 7pm
  * Room Gittings 129b (this room)
  * First hour: review lecture (attendance: 0.5 extra credit)
...
Submit your `absolute` function to Gradescope for attendance.

Name your file `absolute.py`
