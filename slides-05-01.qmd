...
How old are you?
55
You may apply to join the military. You may drink. You may run for president.
</pre>
```
...
3. Write a `main` function to request input from user until it is valid (only digits), print the message
